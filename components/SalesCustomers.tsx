              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-2 gap-4 p-4 bg-gray-50 rounded-2xl">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-gray-900">
                      {customer.lastOrder ? new Date(customer.lastOrder).toLocaleDateString('pt-BR') : 'Sem pedidos'}
                    </p>
                  </div>
                </div>
              </div>
